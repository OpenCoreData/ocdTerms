These notes are for the EDITORS of ocd
...
Make sure you have an ID range in the [idranges file](ocd-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [ocd-edit.owl](ocd-edit.owl)

** DO NOT EDIT ocd.obo OR ocd.owl in the top level directory **

[../../ocd.owl](../../ocd.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/opencoredata/ocdTerms) for details.
 ...
 * [ocd-idranges.owl](ocd-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/ocd_terms.txt file
...
Note: the ocd_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as ocd.owl and ocd.obo and places
 ...
 * https://github.com/opencoredata/ocdTerms/releases
 * https://github.com/opencoredata/ocdTerms/releases/new
...
what is in the `owl:versionIRI` of the derived ocd.owl (`data-version` in
ocd.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/ocd.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/ocd/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/opencoredata/ocdTerms.svg?branch=master)](https://travis-ci.org/opencoredata/ocdTerms)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/opencoredata](https://travis-ci.org/profile/opencoredata)
 2. click the "Sync account" button
 3. Click the tick symbol next to ocdTerms
